...
<html>
	<head>
	<title>String Theory Guitars | Thank You</title>
	...
	<form action="success.php" method="POST">
		<body background="images/background.jpg">
			...
			<div style="background-color: #ffffff; width: 850px;font-family: copperplate gothic light;">
				...
				<br>
				<br><font size="5em;">YOUR ORDER</font><hr width="20%" style="margin-top: 0px;"size="2" color="rgb(156,1,0)" style="clear: both;">
				<div style="min-height: 100px;">
							...
							if (empty($ordered))
							...
							else							
								{
									for ($i=0; $i<count($ordered); $i++)
										...
										$query = "SELECT Price, PID FROM guitars WHERE PID='$id'";
					...
					<input type="submit" name="submit" value = "Confirm!" style=" background:rgb(156,1,0);border:none; color:white; font-family:georgia; font-size:14px; height: 25px; width: 100px; position: relative;top: 20px; left: 20px;border-radius:5px; ">
				</div>
				<br><br>
