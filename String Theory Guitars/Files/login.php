...
<html>
	<head>
	<title>String Theory Guitars | Login</title>
			...
			<div style="background-color: #ffffff; width: 850px;font-family: copperplate gothic light;" >
				...
				<form action="signup-script.php" method="POST">
					<div style="background-color:#EEEEEE; width:310px; float: left;padding-right:20px; height:330px; border-radius:5px;">
						<h2 style="color:rgb(156,1,0); text-align: right;">SIGNUP</h2>
						<table border="0" align="center" width = "200" style="font-family:georgia;font-size:15px;">
							...
							<tr>
								<td colspan = "2">
									<input type="submit" name="submit" value = "Sign Up!" style=" background:rgb(156,1,0);border:none; color:white; font-family:georgia; font-size:14px; height: 25px; width: 100px; border-radius:5px; position:relative; left: 150px; top: 10px;">
								</td>
							</tr>
						</table>
					</div>
				...
				<form action="login-script.php" method="POST">
					<div style="background-color: #EEEEEE;float: right;width: 310px;padding-right: 20px;margin-right: 20px; border-radius:5px;">
						<h2 style="color:rgb(156,1,0); text-align: right;">LOGIN</h2>
						<table border="0" align="center" width = "200" style="font-family:georgia;font-size:15px;">
							<tr>
								<td align="right" width="120" style="padding-right:5px">E-mail:</td>
								<td align="left">
							...
							<tr>
								<td colspan = "2">
									<input type="submit" name="submit" value = "Login!" style=" background:rgb(156,1,0);border:none; color:white; font-family:georgia; font-size:14px; height: 25px; width: 100px; border-radius:5px; position:relative; left: 150px; top: 10px;">
								</td>
							</tr>
							 <tr>
								<td colspan = "2">
